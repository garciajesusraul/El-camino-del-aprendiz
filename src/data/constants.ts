...
// Generador de tareas: vacío por defecto. El padre crea todas las tareas manualmente.
export function generateSeedTasks(_userId: string = 'user_1'): Task[] {
  return [];
}
...
export function getDefaultHabitDefinitions(): HabitDefinition[] {
  // Vacío por defecto: los padres crean los hábitos manualmente. Se mantiene la función para compatibilidad.
  // Los hábitos existentes (como los de LEON) se conservan porque están guardados en localStorage y no se borran.
  return [];
}
